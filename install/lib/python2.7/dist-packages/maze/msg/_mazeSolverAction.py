...
"""autogenerated by genpy from maze/mazeSolverAction.msg. Do not edit."""
import sys
...
class mazeSolverAction(genpy.Message):
  _md5sum = "c4ee0f8ba849cbc37da3f8f4c1ad744e"
  _type = "maze/mazeSolverAction"
...
"""
  ...
  _slot_types = ['maze/mazeSolverActionGoal','maze/mazeSolverActionResult','maze/mazeSolverActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mazeSolverAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = maze.msg.mazeSolverActionGoal()
      if self.action_result is None:
        self.action_result = maze.msg.mazeSolverActionResult()
      if self.action_feedback is None:
        self.action_feedback = maze.msg.mazeSolverActionFeedback()
    else:
      self.action_goal = maze.msg.mazeSolverActionGoal()
      self.action_result = maze.msg.mazeSolverActionResult()
      self.action_feedback = maze.msg.mazeSolverActionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_result.result.success = str[start:end].decode('utf-8')
      else:
        self.action_result.result.success = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.feedback = str[start:end].decode('utf-8')
      else:
