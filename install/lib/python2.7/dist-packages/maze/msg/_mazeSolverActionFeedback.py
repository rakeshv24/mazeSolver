...
"""autogenerated by genpy from maze/mazeSolverActionFeedback.msg. Do not edit."""
import sys
...
class mazeSolverActionFeedback(genpy.Message):
  _md5sum = "99eff65d7d7ea548572edff08e1d4324"
  _type = "maze/mazeSolverActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','maze/mazeSolverFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mazeSolverActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = maze.msg.mazeSolverFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = maze.msg.mazeSolverFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.feedback = str[start:end].decode('utf-8')
      else:
        self.feedback.feedback = str[start:end]
      return self
