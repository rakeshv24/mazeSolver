...
"""autogenerated by genpy from maze/mazeSolverActionResult.msg. Do not edit."""
import sys
...
class mazeSolverActionResult(genpy.Message):
  _md5sum = "3b61ff9bf9f557a8aa70c783c4c7f030"
  _type = "maze/mazeSolverActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','maze/mazeSolverResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(mazeSolverActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = maze.msg.mazeSolverResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = maze.msg.mazeSolverResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.success = str[start:end].decode('utf-8')
      else:
        self.result.success = str[start:end]
      return self
